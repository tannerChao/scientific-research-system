...
//主页面
      ...
      
      {
        title: '',
        dataIndex: '',
        render: text => <a href="javascript:;" onClick={() => { this.opendistribution() }}>分配专家</a>
      }],
...

{
  title: '',
  dataIndex: '',
  render: text => <a href="javascript:;" onClick={() => { this.openexamine() }}>审核</a>
}],
      detailedState: false
    }
  }
  ...
  openexpert = () => {
    console.log(111)
    this.setState({
      expertState: !this.state.expertState
    })
  }
  ...
  opendistribution = () => {
    console.log(111)
    this.setState({
      distributionState: !this.state.distributionState
    })
  }
  ...
  render() {
    let { data,data1,data2, columns,columns1,columns2, detailedState, expertState, distributionState, examineState } = this.state;

    return (
      <div className='scientific-management'>
        <div><Button type="primary" onClick={() => { this.openexpert() }}  style={{ float: "right" }}>分配专家组</Button>
        <Button type="primary" onClick={() => { this.openexamine() }} style={{ float: "right" }} >审核</Button>
        </div>
        ...
        <Modal
          title="分配专家"
          visible={distributionState}
          onOk={this.distributionState}
          onCancel={this.opendistribution}
          wrapClassName='add-project-modal'
          width={250}
        ...
        <Modal
          title="分配专家组"
          visible={expertState}
          onOk={this.expertState}
          onCancel={this.openexpert}
          wrapClassName='add-project-modal'
          width={1000}
        ...
        <Modal
          title="科研处审核"
          visible={examineState}
          onOk={this.examineState}
          onCancel={this.openexamine}
          wrapClassName='add-project-modal'
          width={1000}
